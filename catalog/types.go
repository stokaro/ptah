...
type Column struct {
	...
	// which accepts them), or "" for non-identity columns. The PostgreSQL reader
	// fills it from pg_attribute.attidentity and the Oracle reader from
	// ALL_TAB_IDENTITY_COLS.GENERATION_TYPE; other readers leave it empty.
