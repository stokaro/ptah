...
function selftest() {
  ...
  for (const expected of ['duplicate asset id', 'SVG has no description', 'missing required output schema-viz-security']) {
  ...
  console.log('check-visual-assets.mjs --selftest: OK (duplicates, inaccessible SVG, and missing output rejected)');
}
