...
| `testing.md` (1,081) | contributor | Declarative testing detail | `workflows/testing` + `reference/testing` | keep as backing reference |
| `github_action.md` (627) | contributor | GitHub Action detail | `workflows/ci` | keep as backing reference for `testing/ci` |
