 ...
 */
/** The sections the glossary page groups its terms under, in reading order. */
export const glossaryGroups = {
  schema: 'Schema and migration terms',
  support: 'Database support terms',
  inference: 'Inference migration terms',
  conformance: 'Compatibility evidence terms',
} as const;

export type GlossaryGroup = keyof typeof glossaryGroups;

export interface GlossaryEntry {
  /** The definition shown in the tooltip, and read as text on the glossary page. */
  readonly definition: string;
  /** Which section of the glossary page the term belongs under. */
  readonly group: GlossaryGroup;
  /**
   * The page that teaches the term, as a slug from the docs root. A definition
   * is one or two sentences by design, so every term owes the reader somewhere
   * to go for the rest of it: a glossary that defines and routes nowhere is a
   * dead end (stokaro/ptah#3225).
   */
...
export const glossary: Record<string, GlossaryEntry> = {
  measured: {
    group: 'support',
    learnMore: 'databases/support-evidence',
    definition:
  ...
  certified: {
    group: 'support',
    learnMore: 'databases/support-policy',
    definition:
  ...
  'migration-directory': {
    group: 'schema',
    learnMore: 'concepts/migration-directory',
    definition:
  ...
  revision: {
    group: 'schema',
    learnMore: 'versioned/maintain-history',
    definition:
  ...
  drift: {
    group: 'schema',
    learnMore: 'direct/compare-and-drift',
    definition:
  ...
  'dev-database': {
    group: 'schema',
    learnMore: 'concepts/database-urls-and-dev-databases',
    definition:
  ...
  dialect: {
    group: 'support',
    learnMore: 'concepts/dialects-and-capabilities',
    definition:
  ...
  capability: {
    group: 'support',
    learnMore: 'reference/capabilities',
    definition:
  ...
  'release-line': {
    group: 'support',
    learnMore: 'databases/support-matrix',
    definition:
  ...
  generation: {
    group: 'inference',
    learnMore: 'inference/concepts/generations',
    definition:
  ...
  cutover: {
    group: 'inference',
    learnMore: 'inference/concepts/verification-and-cutover',
    definition:
