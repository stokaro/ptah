...
| [MySQL](../mysql/) | `mysql` | `mysql://`, `mysql+unix://` | Supported, with dialect-specific limitations. |
| [MariaDB](../mysql/) | `mariadb` (`maria`) | `mariadb://`, `maria://`, `mariadb+unix://`, `maria+unix://` | Supported, with dialect-specific limitations. |
