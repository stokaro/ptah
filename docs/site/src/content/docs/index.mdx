...
<CardGrid>
  ...
  <LinkCard title="Schema files" href="./workflows/schema-files/" description="Render and migrate from YAML, Atlas HCL, or SQL schema files." />
...
| YAML, Atlas HCL, or SQL schema files | [Schema files](./workflows/schema-files/) |
