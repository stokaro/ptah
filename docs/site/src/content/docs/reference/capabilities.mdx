...
- A value can be <GlossaryTerm term="measured" /> or
  <GlossaryTerm term="carried" />. The distinction is pinned by
...
- A release line is <GlossaryTerm term="certified" />,
  <GlossaryTerm term="legacy-tested" /> or
  <GlossaryTerm term="best-effort" />. The level says who re-measures the
  preset, not how well the engine works.
