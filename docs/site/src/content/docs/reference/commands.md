...
| `ptah atlas migrate push` | Registered Atlas CE boundary stub for a community-version unsupported command. `--help` prints the Atlas CE unsupported notice and exits 0; direct execution prints the Atlas CE abort text and exits 1. This is an explicit compatibility boundary, not an implemented Ptah feature. |
...
| `ptah atlas schema push` | Registered Atlas CE boundary stub for a community-version unsupported command. `--help` prints the Atlas CE unsupported notice and exits 0; direct execution prints the Atlas CE abort text and exits 1. This is an explicit compatibility boundary, not an implemented Ptah feature. |
