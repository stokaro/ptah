...
| External `--dir-format` outside `migrate import` | 🟡 | ✅ | ✅ | Five external layouts read and write. Goose and dbmate carry a whole-migration no-transaction requirement in their own syntax; three layouts still cannot (stokaro/ptah#1630). |
