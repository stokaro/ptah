...
| Query builder for parameterized SQL | 🟡 | ➖ | ➖ | Joins, DISTINCT, GROUP BY, HAVING, RETURNING, LIKE, upsert, CTEs and subqueries all render. ClickHouse UPDATE/DELETE are mutations and refuse (stokaro/ptah#941). |
