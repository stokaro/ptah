...
| Query builder for parameterized SQL | 🟡 | ➖ | ➖ | Joins, DISTINCT, GROUP BY, HAVING, RETURNING, LIKE, upsert, CTEs and subqueries render. No window functions, arithmetic, non-aggregate function calls or INSERT … SELECT (stokaro/ptah#941). |
