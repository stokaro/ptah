...
| Query builder for parameterized SQL | 🟡 | ➖ | ➖ | Joins, DISTINCT, GROUP BY, HAVING, RETURNING, LIKE, upsert, CTEs, subqueries, arithmetic and function calls render. No window functions or INSERT … SELECT (stokaro/ptah#941). |
