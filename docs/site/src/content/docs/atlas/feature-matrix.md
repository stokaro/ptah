...
| SQL Server and Azure SQL (sqlserver, mssql, tsql) | 🟡 | ❌ | ✅ | Every spelling renders the same DDL. Sequences, roles/grants and row-level security render, read back and plan; functions do not (stokaro/ptah#1720). The engine has no materialized views. |
