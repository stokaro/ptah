...
| Query builder for parameterized SQL | 🟡 | ➖ | ➖ | Joins, DISTINCT, GROUP BY, HAVING, RETURNING, LIKE and upsert work; no subqueries. ClickHouse UPDATE/DELETE are mutations and refuse. Tracked by stokaro/ptah#941. |
