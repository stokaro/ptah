...
| Query builder for parameterized SQL | 🟡 | ➖ | ➖ | Joins, DISTINCT, GROUP BY, HAVING and RETURNING work across every dialect; no subqueries, CTEs, LIKE or upsert. ClickHouse UPDATE/DELETE are mutations and refuse. Tracked by stokaro/ptah#941. |
