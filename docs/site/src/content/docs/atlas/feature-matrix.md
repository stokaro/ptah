...
| SQLite (sqlite, sqlite3) | 🟡 | ✅ | ✅ | Every shape change rebuilds, including since #1707 the column additions ADD COLUMN rejects. An enum change is still erased before comparison. Tracked by stokaro/ptah#1716. |
