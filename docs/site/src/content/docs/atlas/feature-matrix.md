...
| `schema plan --edit` and `--name-format` | ✅ | ❌ | ✅ | `--edit` opens the planned SQL in $VISUAL/$EDITOR and re-derives severity from what you wrote; `--name-format` templates the plan name over .FromHash/.ToHash. |
