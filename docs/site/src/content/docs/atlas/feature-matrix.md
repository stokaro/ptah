...
| Domains, composite types, and range types | 🟡 | ❌ | ✅ | Domains compare CHECK and DEFAULT through the server's own form and change in place. Each kind is gated per target. Composites and ranges still rebuild instead of ALTER (stokaro/ptah#1717). |
