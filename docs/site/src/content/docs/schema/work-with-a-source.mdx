...
Ptah reads the desired schema from SQL, YAML, HCL or DBML files, from annotated
Go structs, and from an external loader. Every one of them parses into the same
