...
<ProductPreview
  ...
  caption="Real self-contained HTML output generated from the four-table documentation fixture."
  ...
  reproduce="ptah schema export --to html --root-dir docs/site/fixtures/schema-ui/internal/models --out schema-document.html"
  variants={[
    {
      id: 'table-detail',
      label: 'One table and its columns',
      src: schemaDocumentTable,
      alt: 'The orders table card in generated Ptah documentation, including its columns, key markers, defaults, references, and index.',
      fullSizeHref: schemaDocumentFull.src,
      downloadHref: schemaDocumentSample,
      sourceHref: schemaDocumentSample,
    },
