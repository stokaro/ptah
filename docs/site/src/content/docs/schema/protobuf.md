...
`--out` file additionally records the rest of the set:
...
:::caution
Files written by a multi-file export declare `ptah:protobuf-export-version=2`. A
Ptah without multi-file support reads one of them in isolation and refuses,
rather than rewriting it as a whole single-file baseline.
:::
...
| `unsupported ptah protobuf export version: file declares export version 3, this Ptah supports 2` | The file was written by a newer Ptah. Upgrade rather than downgrade the file. |
