...
func TestClickHouseDescriptionCarriesNoCredentialLive(t *testing.T) {
	...
	// Every attribute catalog.Role carries beyond a name is a PostgreSQL notion
...
// DIFFERENT fields, exactly as the shared catalog.Grant contract says: a
...
// records it with `table = NULL`, and the shared catalog.Grant contract puts a
