...
func newFuzzRNG(seed uint64) *rand.Rand {
	...
	return rand.New(rand.NewPCG(seed, 0x9E3779B97F4A7C15)) // #nosec -- deterministic shape generation, not security
}
...
func oracleHash(c *qt.C, oracle, dir, format string) oracleOutcome {
	...
	// #nosec -- operator-provided oracle path, and dir is a test temp dir
