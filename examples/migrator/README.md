...
go run ./cmd/ptah migrations status --db-url postgres://user:pass@localhost/db
go run ./cmd/ptah migrations up --db-url postgres://user:pass@localhost/db
go run ./cmd/ptah migrations down --db-url postgres://user:pass@localhost/db --target 1
```
