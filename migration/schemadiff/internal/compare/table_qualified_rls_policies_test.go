...
func TestRLSPoliciesWithSemantics_TableQualifiedRemovals(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			compare.RLSPoliciesWithSemantics(desired, test.current, diff, identifier.ForDialect("postgres"), compare.Coverage{}, nil)
...
func TestRLSPoliciesWithSemantics_ModificationMatchesTheSameTable(t *testing.T) {
	...
	compare.RLSPoliciesWithSemantics(desired, current, diff, identifier.ForDialect("postgres"), compare.Coverage{}, nil)
...
func TestRLSPolicies_DelegatesWithDialectlessSemantics(t *testing.T) {
	...
	compare.RLSPolicies(generatedSharedPolicyName(), current, diff, compare.Coverage{})
