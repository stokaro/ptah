...
func TestExtendedProperties_KeysOnTheAddressAndNotOnTheName(t *testing.T) {
	...
	live := &types.DBSchema{ExtendedProperties: []types.DBExtendedProperty{
...
func TestExtendedProperties_ReportsEachDirection(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			live:        []types.DBExtendedProperty{{Name: "ptah_flag", Schema: "app", Table: "docs", Value: "on", ValueType: "nvarchar"}},
