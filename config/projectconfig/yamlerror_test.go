...
//
// The CLI routes a --config path ending in .hcl to AtlasPath instead
// (stokaro/ptah#1215), so an operator does not reach this message by typing
...
// should not paper over -- and the advice says where the .hcl belongs.
