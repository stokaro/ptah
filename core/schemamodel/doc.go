...
// [ptah.run/catalog], the model of a schema as a live server reports it,
...
// [ptah.run/core/goschema], the YAML front end is
// [ptah.run/core/yamlschema], and a caller that builds a Database itself
