...
//
// goschema.ParseDir and goschema.ParseDirRaw record an absolute md.SourceDir,
// preserving the originating root when several Go roots are merged.
// goschema.ParseFS and goschema.ParseSource cannot provide a host-filesystem
// root, so their relative SourceDir is resolved against rootDir. md.File is
// always resolved relative to that source directory.
