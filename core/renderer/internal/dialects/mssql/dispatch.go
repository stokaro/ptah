...
//
// A kind Ptah does not generate for this target is routed all the same: it
// reaches a handler that names it in the output and records the omission, so
// the declaration the author wrote is reported rather than dropped.
