...
import (
	...
	"ptah.run/cmd/migratedata"
	"ptah.run/cmd/migratedown"
	"ptah.run/cmd/migrateedit"
	"ptah.run/cmd/migratehash"
	"ptah.run/cmd/migratels"
	"ptah.run/cmd/migraterebase"
	"ptah.run/cmd/migraterepair"
	"ptah.run/cmd/migraterm"
	...
	"ptah.run/cmd/migrationspull"
	"ptah.run/cmd/migrationspush"
