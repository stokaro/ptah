//go:build ptah_live_migrate_baseline

package migratebaseline

// White-box testing required: verifyBaseline and the PostgreSQL shadow-database
// helpers are unexported correctness primitives whose live behavior cannot be
// isolated through the public command constructor.
