// Package migratetests holds the external tests of internal/cli/atlas's `migrate` verbs.
//
// It exists for the reason stokaro/ptah#1812 records: internal/cli/atlas was one test
...
// they share live in internal/cli/atlas/internal/atlastest, which is what made the move
// mechanical.
//
// This file carries the package clause and nothing else, because the directory
// holds only tests.
package migratetests
