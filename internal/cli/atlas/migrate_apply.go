...
Native Ptah equivalent: ptah migrations up.`,
	...
	// declaration in internal/cli/migrateup/migrateup.go, and stokaro/ptah#1253.
...
func runAtlasMigrateApplyTarget(
	...
	// internal/cli/atlas/compat_url_diagnostic.go for the measured per-verb table; this
...
// (internal/cli/internal/cmdflags) already binds that flag to PTAH_SKIP_CHECKS. This
