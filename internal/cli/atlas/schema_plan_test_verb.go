...
import (
	...
	"ptah.run/internal/cli/internal/testexternal"
...
func runAtlasSchemaPlanTest(cmd *cobra.Command, opts atlasSchemaPlanTestOptions) error {
	...
	// Loaded twice; see the same shape and reason in internal/cli/schema.
	...
	// container -- the same shape internal/cli/schema/test.go uses. It is also what
