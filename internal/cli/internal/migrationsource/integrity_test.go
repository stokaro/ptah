...
// These rows moved here from internal/cli/migrateup, where they were a white-box test of
...
// everything before it. internal/cli/root's flag-surface gate asserts that every
