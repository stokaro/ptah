...
// call sites live under internal/cli/atlas and internal/atlasschema, and
// internal/cli/atlas/compat_url_diagnostic.go re-words exactly its unsupported-scheme
