...
// TestCredentialRef_AFileTheOwnerAloneCanReadIsAccepted is the control for the
// platform refusal: a check that refused every file would satisfy it and make
// the scheme useless.
