...
// ranges, and composite difftypes. It runs before tables so columns can reference
...
// domains, ranges, and composite difftypes. Modified objects are dropped here and
