...
// in catalog.Database. The boolean result aligns one-for-one with resources.
...
// narrower because a catalog.Database cannot represent these additional catalog kinds.
