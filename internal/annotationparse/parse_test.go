...
`)
	...
	c.Assert(annotation.Directive, qt.Equals, "ptah:schema:field")
	...
	c.Assert(annotation.Attributes[2].Range.Start.Character, qt.Equals, 46)
	c.Assert(annotation.Attributes[2].Range.End.Character, qt.Equals, 52)
}
