...
// document. Compatibility adapters may remove this exact marker while keeping
// every other leading comment, including coverage directives.
const GeneratedCodeMarker = "// Code generated by ptah; DO NOT EDIT."
...
// search_path points.
//
// This renderer writes ten schema-scoped block types -- extension, sequence,
// domain, composite, range, enum, table, function, view, materialized. Measured on
// PostgreSQL 17.10 before these paths were unified, one schema `wf1138s` held
// one object of each original kind; seven of those nine landed in `public`, and
// only `enum` and `table` already reached this helper. See stokaro/ptah#1138,
// stokaro/ptah#1276 for the two that were not, and stokaro/ptah#1441 for
// extension placement.
//
...
// extensionSchemaFor preserves the extension model's exact placement contract:
// only the empty string selects the connection default. A quoted PostgreSQL
// identifier consisting entirely of whitespace is still a real schema name.
//
...
// render actually wrote a `schema.<name>` reference to.
//
...
func (r *renderer) render() {
	...
	r.builder.WriteString(GeneratedCodeMarker + "\n")
...
func (r *renderer) renderSchemas() {
	...
	// a separate declaration. A source that DID declare one keeps what it
	// reported, comment, charset and collation included.
	//
