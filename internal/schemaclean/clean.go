...
func tableObjects(schema *catalog.Database) []Object {
	...
	for _, table := range schema.Tables {
		// Readers that surface views through catalog.Database.Tables as well as
		// catalog.Database.Views tag them here, and viewObjects reports them once.
...
// enumObjects reports PostgreSQL enum types. catalog.Enum carries no schema: the
